 ...
 * lead to a solution. If all choices for the first empty
 * cell in the first row have been tried, there is no solution.
 */
...
public class SudokuApp {
	public static void main(String[] args) {
		...
		System.out.print("Input file with sudoku problem: ");
		String fname = in.nextLine();
		int[][] b = readBoard(fname);
		Sudoku sdk = new Sudoku(b);
	...
	/**
	 * pre : Numbers have been filled in for rows 0 - (row - 1)
